  ...
  <div id="wrapper">
    <div id="receiptData" style="width: auto; max-width: 580px; min-width: 250px; margin: 0 auto;">
      <div id="receipt-data">
            ...
            <p style="text-align:center;"><strong>Se ha realizado el pago con éxito!</strong>                               
            <p>
        ...
        <span class="col-xs-12">
            <button onclick="window.print();" class="btn btn-block btn-sm btn-success">Imprimir</button></span>

            <span class="col-xs-12">
            <a class="btn btn-block btn-sm btn-danger" href="<?php echo site_url('admin/payments/'); ?>">Salir</a>
            </span>
            <div style="clear:both;"></div>
        </div>
        <!-- end -->
